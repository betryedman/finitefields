 ...
 * @author Grzegorz
 */
public class DodawanieWielomianowNadCialeSkonczonym implements ActionListener {
    ...
    public DodawanieWielomianowNadCialeSkonczonym() {
        frame = new JFrame("Dodawanie wielomianów nad ciałem skończonym");
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            case "Dodaj":
                ...
                if(wymiar != null) {
                    if(binarny == true) {
                        JOptionPane.showMessageDialog(null, DodawanieIMnozenieWielomianow.dodaj(
                                ...
                                "Wynik dodawania wielomianów nad ciałem skończonym", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, DodawanieIMnozenieWielomianow.dodajDziesietnie(
                                new Wielomian(Integer.parseInt(dlugoscWielomianu1), cialoGalois.getRozmiarCiala()),
                                new Wielomian(Integer.parseInt(dlugoscWielomianu2), cialoGalois.getRozmiarCiala()),
