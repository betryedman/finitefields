 ...
 * @author Grzegorz
 */
class DziałaniaNaMacierzachNadCialemCieleSkonczonym implements ActionListener {
    ...
    public DziałaniaNaMacierzachNadCialemCieleSkonczonym() {
        frame = new JFrame("Działania na macierzch nad ciałem skończonym");
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            case "Dodawanie":
                frame1 = frame;
                frame = new DodawanieMacierzyNadCialeSkonczonym().getFrame();
                frame.setVisible(true);
